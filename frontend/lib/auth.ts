...
/**
 * @param client ApolloClient to make requests with (from `useApolloClient` or `useApollo`).
 * @param onLogin Callback to call with the JWT (i.e. `const { onLogin } = useApollo()`).
